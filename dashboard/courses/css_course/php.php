        ...
        <div class="sidebar">
            ...
            <div class="section">
                <ul>
                    ...
                    <li><a onclick="changeVideo('/courses/videos/css_session_2.mp4')">PHP Installation</a></li>
                    <li><a onclick="changeVideo('/courses/videos/css_session_2.mp4')">PHP Syntax</a></li>
                    <li><a onclick="changeVideo('/courses/videos/css_session_2.mp4')">PHP Comments</a></li>
                    <li><a onclick="changeVideo('/courses/videos/css_session_2.mp4')">PHP Variables</a></li>
                    <li><a onclick="changeVideo('/courses/videos/css_session_2.mp4')">PHP Data Types</a></li>
                    <li><a onclick="changeVideo('/courses/videos/css_session_2.mp4')">PHP Strings</a></li>
                </ul>
            </div>
        </div>
    </div>
