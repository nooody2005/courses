        ...
        <div class="sidebar">
            ...
            <div class="section">
                <ul>
                    ...
                    <li><a onclick="changeVideo('/courses/videos/css_session_2.mp4')">HTML Editors</a></li>
                    <li><a onclick="changeVideo('/courses/videos/css_session_2.mp4')">HTML Syntax</a></li>
                    <li><a onclick="changeVideo('/courses/videos/css_session_2.mp4')">HTML Elements</a></li>
                    <li><a onclick="changeVideo('/courses/videos/css_session_2.mp4')">HTML Attributes</a></li>
                    <li><a onclick="changeVideo('/courses/videos/css_session_2.mp4')">HTML Headings</a></li>
                    <li><a onclick="changeVideo('/courses/videos/css_session_2.mp4')">HTML Paragraphs</a></li>
                </ul>
            </div>
        </div>
    </div>
