        ...
        <div class="sidebar">
            ...
            <div class="section">
                <ul>
                    ...
                    <li><a onclick="changeVideo('/courses/videos/css_session_2.mp4')">Routing:</a></li>
                    <li><a onclick="changeVideo('/courses/videos/css_session_2.mp4')">Controllers:</a></li>
                    <li><a onclick="changeVideo('/courses/videos/css_session_2.mp4')">Views:</a></li>
                    <li><a onclick="changeVideo('/courses/videos/css_session_2.mp4')">Models:</a></li>
                    <li><a onclick="changeVideo('/courses/videos/css_session_2.mp4')">Migrations:</a></li>
                    <li><a onclick="changeVideo('/courses/videos/css_session_2.mp4')">Database Interaction:</a></li>
                </ul>
            </div>
        </div>
    </div>
